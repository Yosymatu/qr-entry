...
const okSound = "" + new URL("ok-DIyL6tn7.wav", import.meta.url).href;
const ngSound = "" + new URL("ng-D66WS0If.wav", import.meta.url).href;
function App() {
  const okAudioRef = reactExports.useRef(null);
  const ngAudioRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    okAudioRef.current = new Audio(okSound);
    ngAudioRef.current = new Audio(ngSound);
  }, []);
  const [status, setStatus] = reactExports.useState("idle");
  const [msg, setMsg] = reactExports.useState("QRコードをスキャンしてください");
  const [eventName, setEventName] = reactExports.useState("SampleEvent");
  const [minSeq, setMinSeq] = reactExports.useState(100);
  const [checkEvent, setCheckEvent] = reactExports.useState(true);
  const [checkSeq, setCheckSeq] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "glass", style: {
      padding: "16px 24px",
      borderRadius: "16px",
      display: "flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass", style: {
        borderRadius: "24px",
        padding: "48px 64px",
        textAlign: "center",
        position: "relative",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          ...
          height: "200px",
          borderRadius: "50%",
          background: status === "ok" ? "rgba(16, 185, 129, 0.3)" : status === "ng" ? "rgba(239, 68, 68, 0.3)" : status === "error" ? "rgba(245, 158, 11, 0.3)" : "rgba(255, 255, 255, 0.1)",
          filter: "blur(40px)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "glass", style: {
      padding: "16px 24px",
      borderRadius: "16px",
      marginTop: "20px"
